...
hl("DiffAdd", {bg = "#122f2f", fg = oxocarbon.none})
hl("DiffChange", {bg = "#222a39", fg = oxocarbon.none})
hl("DiffText", {bg = "#2f3f5c", fg = oxocarbon.none})
hl("DiffDelete", {bg = "#361c28", fg = oxocarbon.none})
...
hl("Comment", {fg = oxocarbon.base03, bg = oxocarbon.none, italic = true})
...
hl("TelescopePromptPrefix", {fg = oxocarbon.base08, bg = oxocarbon.base02})
...
hl("TelescopeMatching", {fg = oxocarbon.base08, bg = oxocarbon.none, bold = true, italic = true})
...
hl("CmpItemAbbr", {fg = "#adadad", bg = oxocarbon.none})
hl("CmpItemAbbrMatch", {fg = oxocarbon.base05, bg = oxocarbon.none, bold = true})
hl("CmpItemAbbrMatchFuzzy", {fg = oxocarbon.base04, bg = oxocarbon.none, bold = true})
hl("CmpItemMenu", {fg = oxocarbon.base04, bg = oxocarbon.none, italic = true})
